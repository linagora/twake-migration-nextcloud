...
var MockRabbitMQChannel = class extends EventEmitter {
  _publishedMessages = [];
...
var MockRabbitMQConnection = class extends EventEmitter {
  _channels = [];
  isConnected = true;
  constructor() {
    super();
